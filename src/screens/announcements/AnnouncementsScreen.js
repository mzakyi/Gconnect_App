...
const handleDeleteAnnouncement = (announcementId, announcementTitle) => {
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              // ⭐ UPDATED: Pass organizationId as second parameter
  ...
  const getCategoryConfig = (category) => {
    switch (category) {
      case 'event':
        return { icon: 'calendar-star', color: '#7E57C2', bg: '#F3E5F5' };
      case 'academic':
        return { icon: 'school', color: '#26C6DA', bg: '#E0F7FA' };
      case 'sports':
        return { icon: 'basketball', color: '#FFA726', bg: '#FFF3E0' };
      case 'urgent':
        return { icon: 'alert-circle', color: '#EF5350', bg: '#FFEBEE' };
      default:
        return { icon: 'bullhorn', color: '#5C6BC0', bg: '#E8EAF6' };
    }
  };
      ...
      <View style={styles.filterSection}>
        ...
        >
          ...
          <Chip
            ...
            style={[styles.filterChip, filter === 'important' && styles.filterChipActive]}
            textStyle={[styles.filterChipText, filter === 'important' && styles.filterChipTextActive]}
            icon="alert-circle"
          >
            Important
          </Chip>
